...
export const recordSourceSchema = z.enum(["read_tool", "user_edited", "kodely_edited", "file_mentioned"])
...
export const fileMetadataEntrySchema = z.object({
	...
	kodely_read_date: z.number().nullable(),
	kodely_edit_date: z.number().nullable(),
