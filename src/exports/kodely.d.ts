...
type KodelySettings = GlobalSettings & ProviderSettings
interface KodelyAPI extends EventEmitter<KodelyEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): KodelySettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: KodelySettings): Promise<void>
	/**
