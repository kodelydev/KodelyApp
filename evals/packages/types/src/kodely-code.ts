...
export const globalSettingsSchema = z.object({
	...
	showKodelyIgnoredFiles: z.boolean().optional(),
...
const globalSettingsRecord: GlobalSettingsRecord = {
	...
	showKodelyIgnoredFiles: undefined,
...
export const kodelyCodeSettingsSchema = providerSettingsSchema.merge(globalSettingsSchema)

export type KodelyCodeSettings = GlobalSettings & ProviderSettings

export const KODELY_CODE_SETTINGS_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS] as Keys<KodelyCodeSettings>[]
...
export type GlobalState = Omit<KodelyCodeSettings, Keys<SecretState>>

export const GLOBAL_STATE_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS].filter(
	(key: Keys<KodelyCodeSettings>) => !SECRET_STATE_KEYS.includes(key as Keys<SecretState>),
) as Keys<GlobalState>[]
...
export enum KodelyCodeEventName {
	Connect = "connect",
	Message = "message",
...
export const kodelyCodeEventsSchema = z.object({
	[KodelyCodeEventName.Message]: z.tuple([
		z.object({
			taskId: z.string(),
	...
	[KodelyCodeEventName.TaskCreated]: z.tuple([z.string()]),
	[KodelyCodeEventName.TaskStarted]: z.tuple([z.string()]),
	[KodelyCodeEventName.TaskModeSwitched]: z.tuple([z.string(), z.string()]),
	[KodelyCodeEventName.TaskPaused]: z.tuple([z.string()]),
	[KodelyCodeEventName.TaskUnpaused]: z.tuple([z.string()]),
	[KodelyCodeEventName.TaskAskResponded]: z.tuple([z.string()]),
	[KodelyCodeEventName.TaskAborted]: z.tuple([z.string()]),
	[KodelyCodeEventName.TaskSpawned]: z.tuple([z.string(), z.string()]),
	[KodelyCodeEventName.TaskCompleted]: z.tuple([z.string(), tokenUsageSchema, toolUsageSchema]),
	[KodelyCodeEventName.TaskTokenUsageUpdated]: z.tuple([z.string(), tokenUsageSchema]),
})

export type KodelyCodeEvents = z.infer<typeof kodelyCodeEventsSchema>
