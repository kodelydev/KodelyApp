...
export const kodelySettingsSchema = providerSettingsSchema.merge(globalSettingsSchema)

export type KodelySettings = GlobalSettings & ProviderSettings

export const KODELY_SETTINGS_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS] as Keys<KodelySettings>[]
...
export type GlobalState = Omit<KodelySettings, Keys<SecretState>>

export const GLOBAL_STATE_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS].filter(
	(key: Keys<KodelySettings>) => !SECRET_STATE_KEYS.includes(key as Keys<SecretState>),
) as Keys<GlobalState>[]
...
export const kodelyEventsSchema = z.object({
	[KodelyEventName.Message]: z.tuple([
		z.object({
			taskId: z.string(),
	...
	[KodelyEventName.TaskCreated]: z.tuple([z.string()]),
	[KodelyEventName.TaskStarted]: z.tuple([z.string()]),
	[KodelyEventName.TaskModeSwitched]: z.tuple([z.string(), z.string()]),
	[KodelyEventName.TaskPaused]: z.tuple([z.string()]),
	[KodelyEventName.TaskUnpaused]: z.tuple([z.string()]),
	[KodelyEventName.TaskAskResponded]: z.tuple([z.string()]),
	[KodelyEventName.TaskAborted]: z.tuple([z.string()]),
	[KodelyEventName.TaskSpawned]: z.tuple([z.string(), z.string()]),
	[KodelyEventName.TaskCompleted]: z.tuple([z.string(), tokenUsageSchema, toolUsageSchema]),
	[KodelyEventName.TaskTokenUsageUpdated]: z.tuple([z.string(), tokenUsageSchema]),
})

export type KodelyEvents = z.infer<typeof kodelyEventsSchema>
